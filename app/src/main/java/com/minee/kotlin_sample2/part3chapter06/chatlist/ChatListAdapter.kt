...
import com.minee.kotlin_sample2.databinding.ItemChatListBinding
...
class ChatListAdapter(val onItemClicked: (ChatListItem) -> Unit) :
    ...
    inner class ViewHolder(private val binding: ItemChatListBinding) :
        ...
        fun bind(chatListItem: ChatListItem) {
            ...
            binding.buyerIdTextView.text = chatListItem.buyerId
            binding.sellerIdTextView.text = chatListItem.sellerId
