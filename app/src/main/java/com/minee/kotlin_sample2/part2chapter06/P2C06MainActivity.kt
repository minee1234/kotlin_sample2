package com.minee.kotlin_sample2.part2chapter06
...
class P2C06MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_p2_c06_main)
    ...
    private fun startCountDown() {
        currentCountDownTimer = createCountDownTimer(timerSeekBar.progress * 60 * 1000L)
